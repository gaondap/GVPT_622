...
**Answer**:
The equation for a one-tailed p-value would be as follows:
$$
...
**Answer**:
The null hypothesis, where birth rate is represented as μ, is as follows:
$$
