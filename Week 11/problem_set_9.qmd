...
modelsummary(CA_multi, 
             coef_rename = c(vote = "State turnout rate",
                             ...
                             pcthsg = "% of state population that graduated high school",
                             edr = "State with election-day registration"),
...
plot_predictions(CA_multi, condition = "pcthsg") +
  ...
  labs(x = "Percentage of state population that graduated high school",
       ...
       title = "Predicted values for the effect of high school graduation rate on state turnout rate")
```
